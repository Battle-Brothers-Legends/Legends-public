...
myEnumTooltip = "Specialist Skills bonuses (in example Poacher\'s arm) count as 25% for non specialist weapons, but will grow by 5% according to the following rules: 'Level' 5% per level (100% at level 15); 'Week in company (SSU Style)' 5% per week in company (100% at level 15); 'Training' 5% per camp training level (100% when training completed)";
misc.addElement(::MSU.Class.EnumSetting("SpecialistSkillsSetting", "Level", ["Level", "Week in company (SSU Style)", "Training"], "Level Specialist Skills for non specialist weapons by 5% per", myEnumTooltip));
