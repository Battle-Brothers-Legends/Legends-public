...
page.addElement(::MSU.Class.EnumSetting("SpecialistSkillsSetting", "Level", ["Level", "Week in company (SSU Style)", "Training"], "Level Specialist Skills for non specialist weapons by 5% per", myEnumTooltip));
