...
::Const.Items.LegendNamedArmorLayers.extend(::Const.Items.LegendNamedClothLayers);
::Const.Items.LegendNamedArmorLayers.extend(::Const.Items.LegendNamedChainLayers);
::Const.Items.LegendNamedArmorLayers.extend(::Const.Items.LegendNamedPlateLayers);
::Const.Items.LegendNamedArmorLayers.extend(::Const.Items.LegendNamedTabardLayers);
::Const.Items.LegendNamedArmorLayers.extend(::Const.Items.LegendNamedCloakLayers);


::Const.Items.LegendNamedHelmetLayers <- [];
::Const.Items.LegendNamedHelmetLayers.extend(::Const.Items.LegendNamedHoodLayers);
::Const.Items.LegendNamedHelmetLayers.extend(::Const.Items.LegendNamedHelmLayers);
::Const.Items.LegendNamedHelmetLayers.extend(::Const.Items.LegendNamedTopLayers);
::Const.Items.LegendNamedHelmetLayers.extend(::Const.Items.LegendNamedVanityLayers);
