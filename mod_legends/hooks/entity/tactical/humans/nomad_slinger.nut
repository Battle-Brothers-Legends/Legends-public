::mods_hookExactClass("entity/tactical/humans/nomad_slinger", function(o) {
	...
	o.assignRandomEquipment = function () {
		...
		if (!::Tactical.State.isScenarioMode() && ::World.getTime().Days >= ::Const.World.Scaling.Nomads.LegendsSlinger2HSlingDay) {
		...
		if (!::Tactical.State.isScenarioMode() && ::World.getTime().Days >= ::Const.World.Scaling.Nomads.LegendsSlingerBetterArmorDay) {
			armors.extend([
