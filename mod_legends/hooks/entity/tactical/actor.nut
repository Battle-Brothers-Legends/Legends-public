...
//	while(!("BloodSaturation" in o.m)) o = o[o.SuperName];
	...
	*/
	...
	// TODO remove when msu get their shit together
	o.originalOnMovementFinish <- function (_tile) {
	...
	// TODO uncomment when msu get their shit together
...
//		onMovementFinish(); // TODO uncomment when msu get their shit together
		originalOnMovementFinish(_tile); // TODO remove when msu get their shit together
		// restore state
		foreach (i, actor in otherActors)
