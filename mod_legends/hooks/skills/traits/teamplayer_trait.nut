::mods_hookExactClass("skills/traits/teamplayer_trait", function(o)
{
	...
	o.create = function () {
		create();
		this.m.Description = "This character makes sure to always announce %their% intentions to %their% companions in battle. In fact, %they%\'ll never shut the hell up. At least it reduces the chance of accidents happening and %they% feels better when near %their% teammates.";
