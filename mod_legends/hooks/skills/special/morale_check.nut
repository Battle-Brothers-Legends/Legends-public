::mods_hookExactClass("skills/special/morale_check", function(o)
{
	...
	{
		this.m.IsHidden = this.m.Container.getActor().getMoraleState() == ::Const.MoraleState.Steady;
		this.m.Name = ::Const.MoraleStateName[this.m.Container.getActor().getMoraleState()];
