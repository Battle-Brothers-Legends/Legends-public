::mods_hookExactClass("skills/backgrounds/swordmaster_background", function (o) {
	o.create = function ()
	{
		...
		this.m.ID = ::Legends.Backgrounds.getID(::Legends.Background.Swordmaster);
