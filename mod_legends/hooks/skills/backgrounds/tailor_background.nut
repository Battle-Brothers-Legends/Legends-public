::mods_hookExactClass("skills/backgrounds/tailor_background", function (o) {
	o.create = function ()
	{
		...
		this.m.ID = ::Legends.Backgrounds.getID(::Legends.Background.Tailor);
		this.m.Name = "Tailor";
	...
	o.setGender <- function (_gender = -1) {
		...
		this.m.Icon = "ui/backgrounds/background_seamstress.png";
	...
	{
		return ::Legends.Backgrounds.getStats(::Legends.Background.Tailor);
	}
