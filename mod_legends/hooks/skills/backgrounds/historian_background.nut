::mods_hookExactClass("skills/backgrounds/historian_background", function(o)
{
	o.create = function ()
	{
		...
		this.m.BackgroundType = ::Const.BackgroundType.OffendedByViolence | ::Const.BackgroundType.Crusader | ::Const.BackgroundType.Educated;
	}
	...
	{
		return ::Legends.Backgrounds.getStats(::Legends.Background.Historian);
	}
