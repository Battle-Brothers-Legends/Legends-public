::mods_hookExactClass("skills/backgrounds/hunter_background", function(o)
{
	o.create = function ()
	{
		...
		this.m.ID = ::Legends.Backgrounds.getID(::Legends.Background.Hunter);
		this.m.Name = "Hunter";
