::mods_hookExactClass("mapgen/templates/tactical/tiles/desert2", function(o)
{
	o.init = function ()
	{
		...
		::Tactical.setTransitions("tile_desert_02", t);
		::Tactical.setTransitions("tile_legend_desert_05", t);
		::Tactical.setTransitions("tile_legend_desert_06", t);
		::Tactical.setTransitions("tile_legend_desert_07", t);
		::Tactical.setTransitions("tile_legend_desert_08", t);
	}
	...
	o.onFirstPass = function ( _rect )
	{
		...
		tile.BlendPriority = ::Const.Tactical.TileBlendPriority.Desert2;
