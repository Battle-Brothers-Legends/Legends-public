::mods_hookExactClass("crafting/blueprints/large_quiver_of_bolts_blueprint", function (o) {
	o.create = function () {
		this.blueprint.create();
		this.m.ID = "blueprint.large_quiver_of_bolts";
		this.m.Type = ::Const.Items.ItemType.Ammo;
		this.m.PreviewCraftable = ::new("scripts/items/ammo/large_quiver_of_bolts");
		this.m.Cost = 250;
		local ingredients = [
			{
