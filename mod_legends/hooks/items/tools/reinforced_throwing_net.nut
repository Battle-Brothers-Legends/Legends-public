::mods_hookExactClass("items/tools/reinforced_throwing_net", function(o) {
	...
	{
		onEquip();
		if (this.getContainer().getActor().getSkills().hasPerk(::Const.Perks.PerkDefs.LegendNetCasting))
		{
			this.m.RangeMax = 5;
		}
	}
	...
	o.onUpdateProperties <- function ( _properties )
	{
		...
		if (this.getContainer().getActor().getSkills().hasPerk(::Const.Perks.PerkDefs.LegendNetRepair))
		{
