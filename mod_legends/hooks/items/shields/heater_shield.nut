::mods_hookExactClass("items/shields/heater_shield", function(o) {
	...
	o.create = function () {
		...
		this.addVariants();
		this.m.Variant = ::Math.rand(1, 11); //random one is only 1-11 though
		this.m.Block = 20;
	...
	o.onPaintInCompanyColors = function () {
		local bannerID = ::World.Assets.getBannerID() >= 50 ? ::World.Assets.getBannerID() : ::World.Assets.getBannerID() + 11;
