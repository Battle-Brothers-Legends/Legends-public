::mods_hookExactClass("items/weapons/wooden_flail", function(o) {
	...
	o.create = function () {
		create();
		this.m.ItemType = ::Const.Items.ItemType.Weapon | ::Const.Items.ItemType.MeleeWeapon | ::Const.Items.ItemType.OneHanded | ::Const.Items.ItemType.Cultist | ::Const.Items.ItemType.Pitchfork;
