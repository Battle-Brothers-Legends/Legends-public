::Const.World.Spawn.Southern =
{
	...
	[
		...
		},
		{
			...
			Types = [
				{
					Type = ::Const.World.Spawn.Troops.LegendArmoredSighthound,
					Cost = 5
				}
			]
		},
			...
			Types = [
				{
					...
					Guards = [
						{
							Type = ::Const.World.Spawn.Troops.Mortar, //admittedly the weight function is dumb to add here im just straight copying guards from necromancers so every engineer has a mortar
							Cost = 30,
