...
// ::Const.Strings.PerkDescription.Ballistics <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.DevastatingStrikes <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.FortifiedMind <- ::Legends.tooltip(@"
...
//::Const.Strings.PerkDescription.Zweihander <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Student <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.KillingFrenzy <- ::Legends.tooltip(@"
'YOU'RE NEXT!'
...
::Const.Strings.PerkDescription.Pathfinder <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.InspiringPresence <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Stalwart <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Steadfast <- ::Legends.tooltip(@"
Firm and resolute.
...
::Const.Strings.PerkDescription.BattleFlow <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecBow <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecCrossbow <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecAxe <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecCleaver <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecDagger <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecSword <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecSpear <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecPolearm <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SpecMace <- ::Legends.tooltip(@"
...
//::Const.Strings.PerkDescription.Captain <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Gifted <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.BagsAndBelts <- ::Legends.tooltip(@"
Extra pockets.
...
//::Const.Strings.PerkDescription.BatteringRam <- ::Legends.tooltip(@"
//Sturdy!
//
//[color=%passive%][u]Passive:[/u][/color]
...
::Const.Strings.PerkDescription.NineLives <- ::Legends.tooltip(@"
Not done yet!
...
::Const.Strings.PerkDescription.Dodge <- ::Legends.tooltip(@"
Too fast for you!
...
::Const.Strings.PerkDescription.Taunt <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Brawny <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.ShieldBash <- ::Legends.tooltip(@"
'Knock them back!'
...
::Const.Strings.PerkDescription.ShieldExpert <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Backstabber <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.LoneWolf <- ::Legends.tooltip(@"
I work best alone.
...
::Const.Strings.PerkDescription.Recover <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.CripplingStrikes <- ::Legends.tooltip(@"
...
//::Const.Strings.PerkDescription.Weaponmaster <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.CoupDeGrace <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.SteelBrow <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Anticipation <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.BattleForged <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.Relentless <- ::Legends.tooltip(@"
Don't slow down!
...
::Const.Strings.PerkDescription.RallyTheTroops <- ::Legends.tooltip(@"
...
::Const.Strings.PerkDescription.HeadHunter <- ::Legends.tooltip(@"
Go for the head!
