...
::Const.World.Spawn.Troops.OrcWarrior.TitleList = ::Const.Strings.GoblinTitles;

::Const.World.Spawn.Troops.OrcWarlord.TitleList = ::Const.Strings.GoblinTitles;

::Const.World.Spawn.Troops.OrcBerserker.TitleList <- ::Const.Strings.GoblinTitles;
::Const.World.Spawn.Troops.OrcBerserker.NameList <- ::Const.Strings.OrcWarlordNames;
::Const.World.Spawn.Troops.OrcBerserker.Variant = 1;

::Const.World.Spawn.Troops.Greatsword.TitleList <- ::Const.Strings.NobleGreatswordTitles;
::Const.World.Spawn.Troops.Greatsword.NameList <- ::Const.Strings.KnightNames;
::Const.World.Spawn.Troops.Greatsword.Variant = 1;

::Const.World.Spawn.Troops.SkeletonHeavyPolearm.NameList <- ::Const.Strings.AncientDeadNames;
::Const.World.Spawn.Troops.SkeletonHeavyPolearm.TitleList <- null;
::Const.World.Spawn.Troops.SkeletonHeavyPolearm.Variant = 1;

::Const.World.Spawn.Troops.SkeletonHeavyBodyguard.NameList <- ::Const.Strings.AncientDeadNames;
::Const.World.Spawn.Troops.SkeletonHeavyBodyguard.TitleList <- null;
::Const.World.Spawn.Troops.SkeletonHeavyBodyguard.Variant = 1;

::Const.World.Spawn.Troops.GreaterFleshGolem.NameList <- ::Const.Strings.FleshGolemNames;
...
::Const.World.Spawn.Troops.Vampire.NameList <- ::Const.Strings.VampireLordNames;
::Const.World.Spawn.Troops.Vampire.TitleList <- ::Const.Strings.FallenHeroTitles;
