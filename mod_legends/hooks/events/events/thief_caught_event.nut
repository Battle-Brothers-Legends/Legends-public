::mods_hookExactClass("events/events/thief_caught_event", function(o) {
	...
	o.create = function() {
		...
		::Legends.Screens.hook(this, "A", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_33.png[/img]During a short rest, your company managed to catch a thief that tried to make off with some of your supplies. The villain\'s clothes are but rags and looks more skeleton than human. What are you going to do with the crook?";
			_screen.Options[0].Text = "Give that poor soul some food and water.";
			_screen.Options[1].Text = "Give the rotter a good beating.";
			_screen.Options[2].Text = "Put that thief to the sword.";
		});
		::Legends.Screens.hook(this, "B", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_33.png[/img]Under the cloak of night some thief managed to nick some of your supplies. Supplies that will probably be offered back to you in the next settlement...";
		});
		::Legends.Screens.hook(this, "C", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_33.png[/img]%randombrother% gives the thief a proper beating with a short cane. The shaft lands viciously hard and you can hear the sound of the blows passing through the theif\'s almost hollow frame. The beaten culprit wilts and turns and tries hard to get away, but the sellsword is persistent in meting out the punishment. When it\'s all said and done, you leave the beaten thief behind, wimpering and clutching the dirt between frail fingers.";
		});
		::Legends.Screens.hook(this, "D", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_33.png[/img]Feeling bad for the feeble cutpurse, you decide to offer some water and food. The withered person almost snatches the meal away from you and drives a famished face into it. The thief thanks you between every bite.";
		});
		...
		::Legends.Screens.hook(this, "F", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_33.png[/img]As you draw your sword, the thief cowers, beggin for mercy as their mirrored face ripples over the blade\'s fuller and edges. You raise the weapon. The theif screams out that %SPEECH_ON% I\'ll work for you, I\'ll work for free, anything to spare my life.%SPEECH_OFF% You hesitate, your sword still lingering in the air.";
		});
