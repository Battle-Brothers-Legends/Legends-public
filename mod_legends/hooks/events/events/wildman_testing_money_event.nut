::mods_hookExactClass("events/events/wildman_testing_money_event", function(o) {
	...
	o.create = function() {
		...
		::Legends.Screens.hook(this, "A", function(_screen) {
			_screen.Text = "[img]gfx/ui/events/event_04.png[/img]You find %wildman% the wildling stacking crowns into towers. %wildman% leans back from these moneyed manifestations with a wide grin, but then suddenly launches forward, knocking the towers over like a child would their blocks. %wildman% laughs maniacally as the coins scatter, seeing someone playing with money like this is a curious sight. Perhaps the wildling has no real conception of what crowns are good for? If so, maybe... maybe you could take them back?";
