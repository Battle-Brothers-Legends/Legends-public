::mods_hookExactClass("events/events/wound_heals_event", function(o) {
	...
	o.onUpdateScore = function () {
		...
		foreach( bro in brothers )
			if (!::Legends.Backgrounds.hasAny(bro, ::Legends.Background.Slave, ::Legends.Background.LegendDonkey) && bro.getSkills().hasSkillOfType(this.Const.SkillType.TemporaryInjury))
				candidates.push(bro);
