::mods_hookExactClass("scenarios/tactical/scenario_line_battle", function(o)
{
	o.initEntities = function ()
	{
		...
		entity.setScenarioValues();
		items = entity.getItems();
		items.equip(::Const.World.Common.pickHelmet([[1, ::Legends.Helmet.Standard.open_leather_cap]]));
		...
		entity.setScenarioValues();
		items = entity.getItems();
		items.equip(::Const.World.Common.pickHelmet([[1, ::Legends.Helmet.Standard.bascinet_with_mail]]));
