::Const.HairColors.None <- [
	""
];

::Const.Faces.AllHuman <- [
	"bust_head_01",
	"bust_head_02",
	"bust_head_03",
	"bust_head_04",
...
::Const.Bodies.FemaleSkinny <- [
	"bust_female_northern_body_00"
];

::Const.Bodies.SouthernFemaleSkinny <- [
	"bust_female_southern_body_00"
];

::Const.Bodies.FemaleMuscular <- [
	"bust_female_northern_body_01"
];

::Const.Bodies.SouthernFemaleMuscular <- [
	"bust_female_southern_body_01"
];

::Const.Bodies.FemaleThick <- [
	"bust_female_northern_body_02"
];

::Const.Bodies.SouthernFemaleThick <- [
	"bust_female_southern_body_02",
	"bust_female_southern_body_05",
];
...
::Const.Bodies.SouthernFemale <- [
	"bust_female_southern_body_00",
	"bust_female_southern_body_01",
	"bust_female_southern_body_02"
];

::Const.Bodies.NorthernFemale <- [
	"bust_female_northern_body_00",
	"bust_female_northern_body_01",
	"bust_female_northern_body_02"
];
