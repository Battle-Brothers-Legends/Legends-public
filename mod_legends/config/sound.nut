::Const.Sound.getParrySoundByWeaponType <- function(_skill)
{
	...
	else if (item.isWeaponType(::Const.Items.WeaponType.Spear) || item.isWeaponType(::Const.Items.WeaponType.Polearm))
	...
	else if (item.isWeaponType(::Const.Items.WeaponType.Flail) || item.isWeaponType(::Const.Items.WeaponType.Staff))
		return "sounds/combat/legend_parried_04.wav";
	else if (item.isWeaponType(::Const.Items.WeaponType.Mace) || item.isWeaponType(::Const.Items.WeaponType.Axe))
	...
	else if (item.isWeaponType(::Const.Items.ItemType.FencingSword))
