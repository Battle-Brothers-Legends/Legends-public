	...
	Troops = [
		{
			...
			Types = [
				{
					Type = ::Const.World.Spawn.Troops.LegendBasiliskDroneLow,
					Cost = 28
				},
				{
					Type = ::Const.World.Spawn.Troops.LegendBasiliskDrone,
					Cost = 40
				},
				{
					Type = ::Const.World.Spawn.Troops.LegendBasiliskSentry,
					MinR = 200,
					Cost = 50
				}
			]
