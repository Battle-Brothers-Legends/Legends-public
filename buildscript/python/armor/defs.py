...
class Defs:
    brush_only_layers = [ #sounds unused, only for readability
        ...
        {"name": "pauldrons_rusted_mail_patch", "min" : 1, "max" : 3, "layer": "attachment", "impactSound" : "chain", "invSound" : "chain"},
...
{"name": "leather_tunic_bloodstained",                   "layer": "plate", "min": 1, "max": 6, "value" : 20, "con" : 20, "stam" : -2, "impactSound" : "leather", "invSound" : "leather",
