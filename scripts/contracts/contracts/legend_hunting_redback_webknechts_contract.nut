this.legend_hunting_redback_webknechts_contract <- this.inherit("scripts/contracts/contract", {
	...
	function spawnEnemies() {
		...
		local party = this.World.FactionManager.getFactionOfType(this.Const.FactionType.Beasts).spawnEntity(tile, "Redback Webknechts", false, this.Const.World.Spawn.LegendRedbackSpider, 200 * this.getDifficultyMult() * this.getScaledDifficultyMult(), this.Contract.getMinibossModifier());
