this.legends_party_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		bros[0].setStartValuesEx([::Legends.Background.LegendBerserker]);
		...
		bros[1].setStartValuesEx([::Legends.Background.Assassin]);
		...
		bros[3].setStartValuesEx([::Legends.Background.LegendDruid]);
		...
		bros[4].setStartValuesEx([::Legends.Background.LegendCommanderNoble]);
	...
	function onInit()
	{
		...
		::World.Flags.set("IsLegendsParty", true);
	}
