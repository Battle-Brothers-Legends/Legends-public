this.swampgreen3 <- this.inherit("scripts/mapgen/tactical_template", {
	...
	function init()
	{
		...
		t.setBrush(::Const.Direction.N, "transition_swamp_03_N");
		t.setBrush(::Const.Direction.NE, "transition_swamp_03_NE");
		t.setBrush(::Const.Direction.SE, "transition_swamp_03_SE");
		t.setBrush(::Const.Direction.S, "transition_swamp_03_S");
		t.setBrush(::Const.Direction.SW, "transition_swamp_03_SW");
		t.setBrush(::Const.Direction.NW, "transition_swamp_03_NW");
		t.setSocket("socket_earth");
		::Tactical.setTransitions("tile_swamp_green_03", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.Subtype = ::Const.Tactical.TerrainSubtype.PlashyGrass;
		tile.BlendPriority = ::Const.Tactical.TileBlendPriority.Swamp3;
