this.legion_origin_legendary_crypt_event <- this.inherit("scripts/events/events/legends/scenario/legion/legion_event", {
	m = {
		LootTable = [
	...
	function create() {
		...
		this.m.Screens.push({
			ID = "B",
			Text = "[img]gfx/ui/events/event_93.png[/img]{The greenskins initially ignore your approach — opting to go about their business fighting one another or thinking about fighting one another. However, as you descend down the hill, more of them take notice and ready their weapons. The tide of metal and flesh is near endless, with a particularly large lump of a creature leading from the front.}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
		...
		this.m.Screens.push({
			ID = "Defeat",
			Text = "[img]gfx/ui/events/event_73.png[/img]You beat a hasty retreat from the clearing — you turn this way and that through the trees, bushes and overgrown ruins.\n\n What remains of the company waits on your orders. However, you realise that while you lost your pursuers you also lost the trail leading back into the hidden grove. You will need to come back again to find it later...",
			Image = "",
			List = [],
			Characters = [],
			Options = [
