this.legion_origin_item_delivery_event <- this.inherit("scripts/events/events/legends/scenario/legion/legion_event", {
	m = {},
	function create() {
		this.m.ID = "event.legion_origin_item_delivery";
		this.m.Title = "Along the way...";
		this.m.Cooldown = 45.0 * ::World.getTime().SecondsPerDay; //cart arrives, delivers 3 items chosen from an array. reoccurs.
		this.m.Screens.push({
			ID = "A",
