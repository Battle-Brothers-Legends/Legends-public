this.legion_origin_raid_farmstead_event <- this.inherit("scripts/events/events/legends/scenario/legion/legion_event", {
	m = {
		Legionary1 = null,
		Legionary2 = null
	},
	...
	function create() {
		...
		this.m.Screens.push({
			...
			function start(_event) {
				...
				foreach (bro in ::World.getPlayerRoster().getAll()) {
					this.List.push(::Legends.EventList.changeBroExperience(bro, ::Math.rand(40, 345)));
				}
			}
		});
		this.m.Screens.push({
		...
		this.m.Screens.push({
			...
			function start(_event) {
				...
				foreach (bro in ::World.getPlayerRoster().getAll()) {
					this.List.push(::Legends.EventList.changeBroExperience(bro, ::Math.rand(352, 967)));
				}
			}
		});
	}
