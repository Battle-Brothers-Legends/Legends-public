this.legend_warden_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},

	function create() {
		this.character_background.create();
		::Legends.Backgrounds.onCreate(this, ::Legends.Background.LegendWarden);
		...
		this.m.Level = 1;
		this.m.BackgroundType = ::Const.BackgroundType.Combat | ::Const.BackgroundType.Untalented | ::Const.BackgroundType.Ranger | ::Const.BackgroundType.ExpertHunter;
	...
	function onChangeAttributes() {
		...
		return ::Legends.Backgrounds.getStats(::Legends.Background.LegendWarden);
	}
	...
	function onAddEquipment() {
		...
		items.addToBag(::new(::Math.rand(0, 1) == 0 ? "scripts/items/weapons/knife" : "scripts/items/weapons/bludgeon"));
