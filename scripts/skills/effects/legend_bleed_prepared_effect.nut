this.legend_bleed_prepared_effect <- this.inherit("scripts/skills/skill", {
	...
	function getDescription() {
		...
		return "This character is preparing to inflict heavy bleeding. The next " + hits + " doing at least [color=%negative%]" + ::Const.Combat.MinDamageToApplyBleeding + "[/color] damage to hitpoints will cause the target to bleed for the next two turns.";
	}
