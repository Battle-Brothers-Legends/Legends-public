this.profession_legend_personal_seal <- this.inherit("scripts/skills/legend_profession_skill", {
	m = {},

	function create() {
		::Legends.Professions.onCreate(this, ::Legends.Profession.LegendPersonalSeal);
	}
		...
		local ret = [
			{
				...
				text = "Renown for crafting equipment"
			},
			{
				id = 11,
				type = "text",
