this.escaped_slaves_manhunter_ranged <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.EscapedSlavesManhunterRanged;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.EscapedSlavesManhunterRanged.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.EscapedSlavesManhunterRanged);
