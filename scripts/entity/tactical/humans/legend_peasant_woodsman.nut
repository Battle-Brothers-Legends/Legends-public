this.legend_peasant_woodsman <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendPeasantWoodsman;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.LegendPeasantWoodsman.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.LegendPeasantWoodsman);
