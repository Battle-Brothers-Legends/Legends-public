this.legend_manhunter_veteran <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendManhunterVeteranRanged;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.LegendManhunterVeteran.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.LegendManhunterVeteran);
	...
	function assignRandomEquipment()
	{
		...
		if (this.m.Items.hasEmptySlot(::Const.ItemSlot.Offhand) && ::Math.rand(1, 100) <= 90)
		{
			this.m.Items.equip(this.new("scripts/items/tools/throwing_net"));
		}

		if (this.m.Items.getItemAtSlot(::Const.ItemSlot.Mainhand).getID() == "weapon.battle_whip") {
