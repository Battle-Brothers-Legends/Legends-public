this.legend_free_company_infantry <- this.inherit("scripts/entity/tactical/legend_free_company_abstract", {
	m = {
		...
		PerkList = ::Const.EnemyPerks.FreeCompanyInfantry,
		PerkPower = 9
	},
	function create()
	{
		this.m.Type = ::Const.EntityType.FreeCompanyInfantry;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.FreeCompanyInfantry.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.FreeCompanyInfantry);
