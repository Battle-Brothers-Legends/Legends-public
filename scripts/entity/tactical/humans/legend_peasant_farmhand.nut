this.legend_peasant_farmhand <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendPeasantFarmhand;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.LegendPeasantFarmhand.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.LegendPeasantFarmhand);
