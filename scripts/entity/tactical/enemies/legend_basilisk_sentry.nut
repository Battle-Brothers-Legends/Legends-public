this.legend_basilisk_sentry <- this.inherit("scripts/entity/tactical/actor", {
	...
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendBasiliskSentry;
		this.m.BloodType = ::Const.BloodType.Red;
		this.m.XP = ::Const.Tactical.Actor.LegendBasiliskSentry.XP;
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.LegendBasiliskSentry);
