this.legend_goblin_witch_doctor <- this.inherit("scripts/entity/tactical/goblin", {
	...
	function create()
	{
		this.m.Type = ::Const.EntityType.LegendGoblinWitchDoctor;
		this.m.XP = ::Const.Tactical.Actor.LegendGoblinWitchDoctor.XP;
		this.goblin.create();
	...
	function onInit()
	{
		...
		b.setValues(::Const.Tactical.Actor.LegendGoblinWitchDoctor);
		b.Vision = 8;
