this.legend_dawg_item <- this.inherit("scripts/items/accessory/legend_accessory_dog", {
	m = {},

	function create() {
		this.legend_accessory_dog.create();
		this.m.Script = "scripts/entity/tactical/legend_dawg";
	...
	function getDescription() {
		if (this.m.Entity == null) {
			...
			return "The collar of a dawg that has been unleashed onto the battlefield.";
		}
	}
	...
	function onEquip() {
		...
		::Legends.Actives.grant(this, ::Legends.Active.LegendUnleashDawg, function (_skill) {
			_skill.setItem(this);
			_skill.m.Name = "Unleash Dawg";
			_skill.m.Description = "Unleash your dawg and send him charging into the enemy. Needs a free tile adjacent.";
