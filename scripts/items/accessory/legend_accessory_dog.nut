this.legend_accessory_dog <- this.inherit("scripts/items/accessory/accessory", {
	...
	function isAllowedInBag()
	{
		...
		return this.m.AddToBagActor.getSkills().hasSkill("perk.legend_packleader");
	}
	...
	function isChangeableInBattle()
	{
		...
		if (::MSU.isNull(this.m.AddToBagActor))
			return true;
		return this.m.IsChangeableInBattleActor.getSkills().hasSkill("perk.legend_packleader");
	}
