this.legend_blooddrinker <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.ItemType = ::Const.Items.ItemType.Named | ::Const.Items.ItemType.Weapon | ::Const.Items.ItemType.MeleeWeapon | ::Const.Items.ItemType.TwoHanded | ::Const.Items.ItemType.Legendary;
