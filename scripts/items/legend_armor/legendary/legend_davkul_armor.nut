this.legend_davkul_armor <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function onTurnStart()
	{
		...
		local bodyAdded = ::Math.minf(body.getArmorMax(), body.getArmor() + 90.0);
		...
		if (!actor.isHiddenToPlayer())
		{
			...
			::Sound.play(this.m.ImpactSound[::Math.rand(0, this.m.ImpactSound.len() -1)], ::Const.Sound.Volume.RacialEffect * 1.25, actor.getPos());
