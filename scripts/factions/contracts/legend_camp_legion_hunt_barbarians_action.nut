this.legend_camp_legion_hunt_barbarians_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create() {
		this.m.ID = "legend_camp_legion_hunt_barbarians_action";
	...
	function onExecute(_faction) {
		if (_faction.getType() != ::Const.FactionType.FreeCompany)
			return;
		local contract = ::new("scripts/contracts/contracts/legend_camp_legion_hunt_barbarians_contract");
